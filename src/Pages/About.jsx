...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      {useLanguage().text.About.SubHeader}
      <Sparkles className="w-5 h-5 text-blue-400" />
    </p>
  </div>
));
  ...
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    ...
    >
      ...
      <div className="absolute -inset-6 opacity-[25%] z-0 hidden sm:block">
        ...
        <div className="absolute inset-0 bg-gradient-to-l from-cyan-500 via-blue-500 to-teal-400 rounded-full blur-2xl animate-pulse-slow opacity-50" />
  ...
  const statsData = useMemo(() => [
    {
      ...
      value: totalProjects,
      label: text.About.TotalProjects,
    ...
    },
    {
      ...
      label: text.About.YearsExperience,
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "{text.About.Quote}"
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1IjhPtOKhrInXzGi9iKbiBFCrKvfe6L-l/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
              ...
              >
                <FileText className="w-4 h-4 sm:w-5 sm:h-5" /> {text.Home.DownloadCV}
              </button>
              </a>
              ...
              >
                <Code className="w-4 h-4 sm:w-5 sm:h-5" /> {text.Home.ViewProjects}
              </button>
              </a>
            </div>
          </div>
