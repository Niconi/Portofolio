...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    Swal.fire({
      title: text.Contact.sending,
      html: text.Contact.sending,
    ...
    try {
      const formSubmitUrl = 'https://formsubmit.co/wijaya.niconi@gmail.com';
          ...
          >
            ...
            >
              ...
              >
                ...
                {isSubmitting ? text.Contact.sending : text.Contact.sendButton}
              </button>
            </form>
