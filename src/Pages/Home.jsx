...
const CTAButton = memo(({ href, text, icon: Icon }) => (
  <a href={href}>
    <button className="group relative w-[160px]">
      ...
      <div className="relative h-11 bg-bgDark backdrop-blur-xl rounded-lg border border-white/10 leading-none overflow-hidden">
...
const TECH_STACK = ["React Native", "Flutter", "Javascript", "Node.js"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Niconi" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/nicholas-suwandi/" },
  { icon: Instagram, link: "https://www.instagram.com/wijaya.niconi" }
];
  ...
  const handleTyping = useCallback(() => {
    if (isTyping) {
      if (charIndex < WORDS[wordIndex].length) {
        setTextTyping(prev => prev + WORDS[wordIndex][charIndex]);
      ...
      if (charIndex > 0) {
        setTextTyping(prev => prev.slice(0, -1));
        setCharIndex(prev => prev - 1);
      } else {
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex flex-row gap-3 w-full justify-start" data-aos="fade-up" data-aos-delay="1400">
                  <CTAButton href="#Portofolio" text={text.Home.ViewProjects} icon={ExternalLink} />
                  <CTAButton href="#Contact" text={text.Navbar.Contact} icon={Mail} />
                </div>
            ...
            <div className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0"
              ...
              <div className="relative w-full opacity-90">
                ...
                <div className={`absolute inset-0 pointer-events-none transition-all duration-700 ${
                  ...
                  <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-br from-primary/10 to-secondary/10 blur-3xl animate-[pulse_6s_cubic-bezier(0.4,0,0.6,1)_infinite] transition-all duration-700 ${
